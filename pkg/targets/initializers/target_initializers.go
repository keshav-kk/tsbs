...
import (
	...
	"github.com/keshav-kk/tsbs/pkg/targets/akumuli"
	"github.com/keshav-kk/tsbs/pkg/targets/cassandra"
	"github.com/keshav-kk/tsbs/pkg/targets/clickhouse"
	"github.com/keshav-kk/tsbs/pkg/targets/constants"
	"github.com/keshav-kk/tsbs/pkg/targets/crate"
	"github.com/keshav-kk/tsbs/pkg/targets/influx"
	"github.com/keshav-kk/tsbs/pkg/targets/mongo"
	"github.com/keshav-kk/tsbs/pkg/targets/prometheus"
	"github.com/keshav-kk/tsbs/pkg/targets/siridb"
	"github.com/keshav-kk/tsbs/pkg/targets/timescaledb"
	"github.com/keshav-kk/tsbs/pkg/targets/timestream"
	"github.com/keshav-kk/tsbs/pkg/targets/victoriametrics"
	"strings"
)
